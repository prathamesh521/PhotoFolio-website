...
{
	$alternate 	= ( $block_order % 2 == 0 ) ? '-alternate' : '';
...
function lightspeed_contact( $color = '', $class = '', $include_address = true )
{
	$company_address 	= lightspeed_get_attribute( 'company_address', get_option( 'areoi-lightspeed-company-address', null ) );
	$company_phone 		= lightspeed_get_attribute( 'company_phone', get_option( 'areoi-lightspeed-company-phone', null ) );
	$company_email 		= lightspeed_get_attribute( 'company_email', get_option( 'areoi-lightspeed-company-email', null ) );
		...
		<?php if ( $company_email || $company_phone ) : ?>
			<p class="<?php echo $class ?> <?php echo $color ?>">
				...
				<?php if ( $company_phone ) : ?>
					...
					<a href="mailto:<?php echo $company_email ?>" class="<?php echo $color ?> me-4"><?php echo $company_email ?></a>
				<?php endif; ?>
...
function lightspeed_media_carousel( $medias, $type = 'square' )
{
	?>
		...
		<div class="carousel-inner">
			<?php foreach ( $medias as $gallery_key => $media ) : ?>
				<div class="carousel-item <?php echo $gallery_key == 0 ? 'active' : '' ?>">
					<div class="areoi-media-col">
						<div class="areoi-media-col-content areoi-has-mask">
					...
					<div class="accordion-body">
						...
						<div class="row">
							...
							<?php if ( lightspeed_get_media( $item ) ) : ?>
								<div class="col-12 col-lg-6 areoi-media-col">
