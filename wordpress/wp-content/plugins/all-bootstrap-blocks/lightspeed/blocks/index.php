...
function lightspeed_render_block( $block_type, $attributes, $content ) 
{
	...
	if ( get_option( 'areoi-lightspeed-styles-strip-alignment', false ) ) {
		if ( empty( $attributes['alignment'] ) && !in_array( $block_type, array( 'call-to-action' ) ) ) {
			if ( $block_order % 2 == 0 ) {
...
function lightspeed_get_extra_metas( $meta, $block_key )
{
	...
	if ( !empty( $meta['supports']['lightspeed_content'] ) ) {
		...
		$meta['attributes']['introduction'] = array(
			'type' => 'string',
			'default' => '<p>"The Blink Test" refers to the commonly accepted 3-5 seconds during which a visitor lands on your website, judges it, and decides if they want to stay there and do something or abandon ship.</p>'
		);
	...
	if ( !empty( $meta['supports']['lightspeed_media'] ) ) {
		...
		$meta['attributes']['image'] = array(
			'type' => 'object',
			'default' => lightspeed_get_placeholder_images( 2 )
		);
...
{
	return '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque ac molestie tellus, id fringilla velit. Donec ultrices consequat augue auctor aliquam. Morbi venenatis semper diam, ut facilisis tellus.</p>';
}
...
function lightspeed_get_placeholder_images( $key = null )
{
	$images = array(
		array(
			'id' => 1,
			'title' => 'pexels-mikhail-nilov-7661408',
			'filename' => 'pexels-mikhail-nilov-7661408.jpg',
			'url' => '' . AREOI__PLUGIN_LIGHTSPEED_URI . '/assets/placeholders/pexels-mikhail-nilov-7661408.jpg',
			'mime' => 'image/jpeg',
			'type' => 'image',
			'subtype' => 'jpeg',
			'height' => 1280,
		...
		array(
			'id' => 2,
			'title' => 'pexels-mikhail-nilov-7661480',
			'filename' => 'pexels-mikhail-nilov-7661480.jpg',
			'url' => '' . AREOI__PLUGIN_LIGHTSPEED_URI . '/assets/placeholders/pexels-mikhail-nilov-7661480.jpg',
			'mime' => 'image/jpeg',
			'type' => 'image',
			'subtype' => 'jpeg',
			'height' => 1280,
		...
		array(
			'id' => 3,
			'title' => 'pexels-mikhail-nilov-7661600',
			'filename' => 'pexels-mikhail-nilov-7661600.jpg',
			'url' => '' . AREOI__PLUGIN_LIGHTSPEED_URI . '/assets/placeholders/pexels-mikhail-nilov-7661600.jpg',
			'mime' => 'image/jpeg',
			'type' => 'image',
			'subtype' => 'jpeg',
			'height' => 1280,
		...
		array(
			'id' => 4,
			'title' => 'pexels-mikhail-nilov-7662307',
			'filename' => 'pexels-mikhail-nilov-7662307.jpg',
			'url' => '' . AREOI__PLUGIN_LIGHTSPEED_URI . '/assets/placeholders/pexels-mikhail-nilov-7662307.jpg',
			'mime' => 'image/jpeg',
			'type' => 'image',
			'subtype' => 'jpeg',
			'height' => 1280,
...
function lightspeed_get_placeholder_videos( $key = null )
{
	$videos = array(
		array(
			'id' => 1,
			'title' => 'astronaut-1',
			'filename' => 'astronaut-1.mp4',
			'url' => '' . AREOI__PLUGIN_LIGHTSPEED_URI . '/assets/placeholders/astronaut-1.mp4',
			'mime' => 'video/mp4',
			'type' => 'video',
			'subtype' => 'mp4',
			'height' => 1280,
		...
		array(
			'id' => 2,
			'title' => 'astronaut-2',
			'filename' => 'astronaut-2.mp4',
			'url' => '' . AREOI__PLUGIN_LIGHTSPEED_URI . '/assets/placeholders/astronaut-2.mp4',
			'mime' => 'video/mp4',
			'type' => 'video',
			'subtype' => 'mp4',
			'height' => 1280,
		...
		array(
			'id' => 3,
			'title' => 'astronaut-3',
			'filename' => 'astronaut-3.mp4',
			'url' => '' . AREOI__PLUGIN_LIGHTSPEED_URI . '/assets/placeholders/astronaut-3.mp4',
			'mime' => 'video/mp4',
			'type' => 'video',
			'subtype' => 'mp4',
			'height' => 1280,
		...
		array(
			'id' => 4,
			'title' => 'astronaut-4',
			'filename' => 'astronaut-4.mp4',
			'url' => '' . AREOI__PLUGIN_LIGHTSPEED_URI . '/assets/placeholders/astronaut-4.mp4',
			'mime' => 'video/mp4',
			'type' => 'video',
			'subtype' => 'mp4',
			'height' => 1280,
...
function lightspeed_get_placeholder_logos()
{
	$videos = array(
		array(
			...
			'url' => '' . AREOI__PLUGIN_LIGHTSPEED_URI . '/assets/placeholders/3d-square.svg',
			'mime' => 'image/svg',
			'type' => 'image',
			'subtype' => 'svg',
			'height' => 1280,
		...
		array(
			...
			'title' => 'shapey',
			'filename' => 'shapey.svg',
			'url' => '' . AREOI__PLUGIN_LIGHTSPEED_URI . '/assets/placeholders/shapey.svg',
			'mime' => 'image/svg',
			'type' => 'image',
			'subtype' => 'svg',
			'height' => 1280,
		...
		array(
			...
			'title' => 'speech',
			'filename' => 'speech.svg',
			'url' => '' . AREOI__PLUGIN_LIGHTSPEED_URI . '/assets/placeholders/speech.svg',
			'mime' => 'image/svg',
			'type' => 'image',
			'subtype' => 'svg',
			'height' => 1280,
		...
		array(
			...
			'url' => '' . AREOI__PLUGIN_LIGHTSPEED_URI . '/assets/placeholders/triangle-creative.svg',
			'mime' => 'image/svg',
			'type' => 'image',
			'subtype' => 'svg',
			'height' => 1280,
		...
		array(
			...
			'title' => 'waves',
			'filename' => 'waves.svg',
			'url' => '' . AREOI__PLUGIN_LIGHTSPEED_URI . '/assets/placeholders/waves.svg',
			'mime' => 'image/svg',
			'type' => 'image',
			'subtype' => 'svg',
			'height' => 1280,
